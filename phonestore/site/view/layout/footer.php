                        ...
                        <div class="col-xl-4 col-lg-5 col-md-5">
                            <div class="single-footer footer-about">
                                ...
                                <div class="footer-brief">
                                    <p>PhoneStore cửa hàng chuyên cung cấp điện thoại chính hãng, giá tốt. Hãy đặt
                                        hàng tại cửa hàng của chúng tôi để nhận ưu đãi hấp dẫn nhé</p>
                                    <p>Địa chỉ: 331 QL1A, An Phú Đông, Quận 12, TPHCM</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="copyright-text">
                                <p class="copy-text"> © 2024 <strong>Phone Store</strong> Tạo bởi 
                                    <a class="company-name" href="#">
                                        <strong> HoangTho</strong></a>.</p>
